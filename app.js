...
let uiController = (function() {
    ...
    let DomStrings = {
        ...
        inputBtn: '.add__btn',
        incomeContainer: '.income__list',
        expenseContainer: '.expenxe__list',
    };
    ...
    return {
        ...
        addlistItem: function(obj, type) {
            ...
            newHtml = html.replace('%blah%', input.id);
            newHtml = newHtml.replace('%blah blah%', input.description);
            newHtml = newHtml.replace('%blah blah blah', input.value);
